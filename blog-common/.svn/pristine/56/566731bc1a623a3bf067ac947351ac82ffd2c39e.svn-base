...
public class RandomNumberUtil {  
   ...
   public static final String[] LETTERS = {"A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "L", "M",  
	       "N", "P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y", "Z"};
   private ByteArrayInputStream image;// 图像  
   private String str;// 验证码  
   private ByteArrayOutputStream imageOps;// 图像  
    ...
    * 取得RandomNumUtil实例 
    */  
   public static RandomNumberUtil Instance() {  
   ...
   public ByteArrayOutputStream getImageOps(){
