		...
		<form class="layui-form" style="margin-left:20%;margin-top:25px;">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" value="${user.username}" name="username" readonly="readonly" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="nickname" value="${user.nickname}" name="nickname" placeholder="请输入昵称" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="email" value="${user.email}" name="email" lay-verify="required" placeholder="请输入邮箱" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">手机号</label>
				<div class="layui-input-inline">
					<input type="text" id="mobile" value="${user.mobile}" name="mobile" lay-verify="required" placeholder="请输入手机号" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">QQ号</label>
				<div class="layui-input-inline">
					<input type="text" id="qq" value="${user.qq}" name="qq" placeholder="请输入QQ号" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">出生日期</label>
				<div class="layui-input-inline">
					<input type="text" id="birthday" value="${user.birthday}" name="birthday" placeholder="请输入出生日期" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="radio" name="status" value="1" title="启用" <c:if test="${user.status=='1'}">checked</c:if>>
					<input type="radio" name="status" value="0" title="禁用" <c:if test="${user.status=='0'}">checked</c:if>>
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" value="${user.company}" name="company" placeholder="请输入公司名称" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">博客地址</label>
				<div class="layui-input-inline">
					<input type="text" value="${user.blog}" name="blog" placeholder="请输入博客地址" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">地址</label>
				<div class="layui-input-inline">
					<input type="text" value="${user.location}" name="location" placeholder="请输入地址" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item layui-form-text">
				<label class="layui-form-label">备注信息</label>
				<div class="layui-input-block">
					<textarea id="remark" name="remark" placeholder="12个汉字以内" class="layui-textarea">${user.remark}</textarea>
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-input-inline" style="float: left">
					<button class="layui-btn id="addbtn" layui-btn-lg layui-btn-danger" lay-submit lay-filter="editUser" style="margin-left: 45%;">修改用户</button>
